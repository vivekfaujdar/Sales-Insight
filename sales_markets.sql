...
CREATE TABLE `markets` (
  `markets_code` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  `markets_name` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
-- Dump completed on 2022-06-28 14:00:17
