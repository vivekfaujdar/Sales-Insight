...
CREATE TABLE `customers` (
  `customer_code` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  `custmer_name` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `customer_type` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
-- Dump completed on 2022-06-28 14:00:18
